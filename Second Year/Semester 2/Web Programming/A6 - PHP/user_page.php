    ...
    <body>
        <div class="container text-center">
            ...
            <form method="post">
                ...
                <input type="submit" class="btn btn-primary" name="addLogButton" value="Add a log report">
                <input type="submit" class="btn btn-primary" name="removeLogButton" value="Remove a log report">
