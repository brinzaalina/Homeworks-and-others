...
public class ArticleController {
    ...
    void addArticle(@RequestBody ArticleDTO articleDTO) {
        ...
        articleService.addArticle(article.getTitle(), article.getText(), article.getCategory());
    ...
    void updateArticle(@PathVariable Long id, @RequestBody ArticleDTO articleDTO) {
        ...
        var article = articleConverter.convertDtoToModel(articleDTO);
        logger.trace("updateArticle - converted - article: " + article);
        articleService.updateArticle(id, article.getTitle(), article.getText(), article.getCategory());
