...
class GUI:
    ...
    def start(self):
        ...
        btn_exit.grid(row=5, column=1, sticky='nsew', padx=10, pady=10)
    ...
    def add_student(self):
        try:
            ...
            student_service.add(text1, text2, int(text3))
    ...
    def remove_student(self):
        try:
            ...
            student_service.remove(text1)
            grade_service.remove_by_student(text1)
        except RepositoryException as re:
            self.window2 = tk.Tk()
            self.window2.configure(bg='#FFDDE2')
            label = tk.Label(master=self.window2, text=str(re), bg='#FFDDE2')
    ...
    def update_student(self):
        try:
            ...
            student_service.update(text1, text2, int(text3))
        except RepositoryException as re:
            self.window2 = tk.Tk()
            self.window2.configure(bg='#FFDDE2')
            label = tk.Label(master=self.window2, text=str(re), bg='#FFDDE2')
    ...
    def add_assignment(self):
        try:
            ...
            assignment_service.add(text1, text2, date(int(text3), int(text4), int(text5)))
        except RepositoryException as re:
            self.window2 = tk.Tk()
            self.window2.configure(bg='#FFDDE2')
            label = tk.Label(master=self.window2, text=str(re), bg='#FFDDE2')
    ...
    def remove_assignment(self):
        try:
            ...
            assignment_service.remove(text1)
            grade_service.remove_by_assignment(text1)
        except RepositoryException as re:
            self.window2 = tk.Tk()
            self.window2.configure(bg='#FFDDE2')
            label = tk.Label(master=self.window2, text=str(re), bg='#FFDDE2')
    ...
    def update_assignment(self):
        try:
            ...
            assignment_service.update(text1, text2, date(int(text3), int(text4), int(text5)))
        except ValueError as ve:
            self.window2 = tk.Tk()
            self.window2.configure(bg='#FFDDE2')
            label = tk.Label(master=self.window2, text=str(ve), bg='#FFDDE2')
        ...
        try:
            if student_id in student_ids:
                if assignment_id in assignment_ids:
                    grade_service.remove(student_id, assignment_id)
                else:
    ...
    def give_assignment_to_student(self):
        ...
        try:
            if student_id in student_ids:
                if assignment_id in assignment_ids:
                    grade_service.add(student_id, assignment_id, 0)
                else:
                    raise RepositoryException("No such assignment id in the list!")
            else:
                raise RepositoryException("No such student id in the list!")
    ...
    def grade_an_assignment(self):
        try:
            ...
            if assignment_id in assignments:
                ...
                grade_service.grade(student_id, assignment_id, grade)
            else:
    ...
    def statistics_1(self):
        ...
        for index in range(len(unique_assignments)):
            ...
            label2.pack()
            unique_students = statistics.statistics_1(unique_assignments[index])
    ...
    def statistics_2(self):
        ...
        label_title.pack()
        unique_late_students_all = statistics.statistics_2()
    ...
    def statistics_3(self):
        ...
        label_title.pack()
        best_students = statistics.statistics_3()
