...
class UI:
    ...
    def delete_vertex_ui(self):
        ...
        deleted = self._graphs[self._current].remove_vertex(vertex)  # check if the vertex is valid and delete it if it is
        if deleted:
    ...
    def remove_edge_ui(self):
        ...
        vertex_x = int(input("Enter x = "))
        vertex_y = int(input("Enter y = "))
        deleted = self._graphs[self._current].remove_edge(vertex_x, vertex_y)  # check if the edge is valid and delete it if it is
        if deleted:
